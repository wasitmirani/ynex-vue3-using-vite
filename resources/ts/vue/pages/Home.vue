        ...
        <header class="app-header"> <!-- Start::main-header-container -->
            <div class="main-header-container container-fluid"> <!-- Start::header-content-left -->
                ...
                <div class="header-content-right"> <!-- Start::header-element -->
                    ...
                    <div class="header-element"> <!-- Start::header-link|switcher-icon --> <a href="#"
                        ...
                        <!-- End::header-link|switcher-icon --> </div> <!-- End::header-element -->
        ...
        <div class="main-content app-content">
            <div class="container-fluid"> <!-- Start::page-header -->
                <div class="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
                    <div>
                        <p class="fw-semibold fs-18 mb-0">Welcome back, Json Taylor !</p><span
                            class="fs-semibold text-muted">Track your sales activity, leads and deals here.</span>
                    </div>
                    <div class="btn-list mt-md-0 mt-2"> <button type="button" class="btn btn-primary btn-wave"> <i
                                class="ri-filter-3-fill me-2 align-middle d-inline-block"></i>Filters </button> <button
                            type="button" class="btn btn-outline-secondary btn-wave"> <i
                                class="ri-upload-cloud-line me-2 align-middle d-inline-block"></i>Export </button>
                    </div>
                                                ...
                                                <div class="d-flex align-items-center justify-content-between">
                                                    <div>
                                                        <div class="fw-semibold fs-18 text-fixed-white mb-2">Your target
                                                            is incomplete</div> <span
                                                            class="d-block fs-12 text-fixed-white"><span
                                ...
                                <div class="row">
                                                ...
                                                <div class="d-flex align-items-top justify-content-between">
                                                    ...
                                                    <div class="flex-fill ms-3">
                                                        ...
                                                        <div
                                                            ...
                                                            <div class="text-end">
                                                                <p class="mb-0 text-success fw-semibold">+40%</p><span
                                                                    class="text-muted op-7 fs-11">this month</span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                    ...
                                    <div class="col-xxl-6 col-lg-6 col-md-6">
                                        <div class="card custom-card overflow-hidden">
                                            <div class="card-body">
                                                <div class="d-flex align-items-top justify-content-between">
                                                    <div> <span class="avatar avatar-md avatar-rounded bg-secondary"> <i
                                                    ...
                                                    <div class="flex-fill ms-3">
                                                        ...
                                                        <div
                                                            ...
                                                            <div class="text-end">
                                                                <p class="mb-0 text-success fw-semibold">+25%</p><span
                                                                    class="text-muted op-7 fs-11">this month</span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="d-flex align-items-top justify-content-between">
                                                    ...
                                                    <div class="flex-fill ms-3">
                                                        ...
                                                        <div
                                                            ...
                                                            <div class="text-end">
                                                                <p class="mb-0 text-danger fw-semibold">-12%</p><span
                                                                    class="text-muted op-7 fs-11">this month</span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="d-flex align-items-top justify-content-between">
                                                    ...
                                                    <div class="flex-fill ms-3">
                                                        ...
                                                        <div
                                                            ...
                                                            <div class="text-end">
                                                                <p class="mb-0 text-success fw-semibold">+19%</p><span
                                                                    class="text-muted op-7 fs-11">this month</span>
                                                            </div>
                                                        </div>
                                                    </div>
                                        ...
                                        <div class="card custom-card">
                                            ...
                                            <div class="card-body">
                                                <div class="d-flex align-items-center mb-3">
                                                    ...
                                                    <div class="ms-2"> <span class="badge bg-success-transparent">1.02<i
                                                    ...
                                                    <ul class="list-unstyled mb-0 crm-recent-activity">
                                                            ...
                                                            <div class="d-flex align-items-top">
                                                                ...
                                                                <div class="crm-timeline-content"> <span
                                                                        ...
                                                                        &amp;</span><span><a href="javascript:void(0);"
                                                                            ...
                                                                            events in next week.</a></span> </div>
                                                        ...
                                                        <li class="crm-recent-activity-content">
                                                            <div class="d-flex align-items-top">
                                                                ...
                                                                <div class="crm-timeline-content"> <span>Neon Tarly
                                                                        added <span class="text-info fw-semibold">Robert
                                                        ...
                                                        <li class="crm-recent-activity-content">
                                                            <div class="d-flex align-items-top">
                                                                ...
                                                                <div class="crm-timeline-content"> <span>Replied to new
                                                                        support request <i
