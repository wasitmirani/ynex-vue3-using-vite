...
<body>
    ...
    <script src="/assets/libs/%40simonwep/pickr/pickr.es5.min.js"></script> <!-- JSVector Maps JS -->
    <script src="/assets/libs/jsvectormap/js/jsvectormap.min.js"></script> <!-- JSVector Maps MapsJS -->
    <script src="/assets/libs/jsvectormap/maps/world-merc.js"></script> <!-- Apex Charts JS -->
    <script src="/assets/libs/apexcharts/apexcharts.min.js"></script> <!-- Chartjs Chart JS -->
    <script src="/assets/libs/chart.js/chart.min.js"></script> <!-- CRM-Dashboard -->
    <script src="/assets/js/crm-dashboard.js"></script> <!-- Custom-Switcher JS -->
